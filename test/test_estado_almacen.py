...
def test_estado_almacen():
    ...
    for producto in productos:
        assert_that(producto,description='Se ha cargado mal el producto').is_instance_of(Producto)
        
   
    assert_that(almacen, description='Se ha cargado mal el almacen').is_not_empty()
